...
class Trainer(BaseTrainer):
  """Same as `dp2_adagrad`, except we apply preconditioner *after* adding noise."""
  ...
  def train(self):
    ...
    def batch_update(branch, iter_idx, key, state, batch):
      ...
      if branch == 2:
        ...
        ######## EXP: apply preconditioner AFTER noise ########
        noisy_grad = privatize_grad(example_grads, key, self.clip1, noise_mult)
    ...
    def branch_fn(i, interval=self.interval):
      ...
      on_interval = (i + 1) % interval == 0
      use_adaptive = (i // interval) % 2 == 1
